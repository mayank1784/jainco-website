...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: `Privacy policy of using Jainco Decor website and mobile app`,
    keywords: ["Jainco Decor", "home decor", "privacy policy"],
  };
}
...
export default async function Page() {
  return (
    <>
      ...
      <p>
        This privacy policy applies to the Jainco Decor app {`(`}hereby referred
        to as &quot;Application&quot;{`)`} for mobile devices that was created
        by Jain Enterprises (hereby referred to as &quot;Service Provider&quot;)
      ...
      <p>
        ...
        address, gstin, phone number, app analytics. The information that the
        Service Provider request will be retained by them and used as described
      ...
      <p>
        ...
        Application, please contact them at jaincodecor@gmail.com and they will
      ...
      <div>
        ...
        <p>
          ...
          the Service Provider {`(`}jaincodecor@gmail.com{`)`} so that they will
      ...
      <br />
      <p>This privacy policy is effective as of 2024-08-22</p>
      <br />
      ...
      <p>
        ...
        Provider via email at jaincodecor@gmail.com.
      </p>
      <hr />
    </>
  );
